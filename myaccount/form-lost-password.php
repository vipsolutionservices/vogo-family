...
<form method="post" class="woocommerce-ResetPassword lost_reset_password">
	...
	<p class="woocommerce-form-row woocommerce-form-row--first form-row form-row-first" style="padding-top: 0px;">
		...
		<input class="woocommerce-Input woocommerce-Input--text input-text" type="text" placeholder=" " name="user_login" id="user_login" autocomplete="username" required aria-required="true" />
		<label for="user_login">Adresa de email *</label>
	</p></div>
