<?php
/*
Plugin Name: Vogo API
Plugin URI: https://vogo.family
Description: Core REST API endpoints for Vogo (JWT auth, forum-chat, orders, mobile).
Version: 1.0.0
Author: Vogo
Author URI: https://vogo.family
Text Domain: vogo-api
...
add_action('plugins_loaded', function () {
    ...
    if (is_dir($rest_dir)) {
        foreach (glob($rest_dir . '/*.php') as $file) { require_once $file; }
    }
});
...
// require_once $rest_dir . 'all-payments-stripe.php';
