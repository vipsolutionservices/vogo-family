...
<input type="file" name="reply_image" id="vogo-file-upload" accept="image/*" style="display:none;">
                        <label for="vogo-file-upload" class="vogo-file-label" style="display:inline-block; padding:6px 16px; background:#009d81; color:#fff; border-radius:5px; cursor:pointer; font-size:14px; margin-bottom:6px; position:relative; font-family: "gotham-book", Arial, Helvetica, sans-serif;"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="20px" fill="#fff"><!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.--><path d="M288 109.3L288 352c0 17.7-14.3 32-32 32s-32-14.3-32-32l0-242.7-73.4 73.4c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3l128-128c12.5-12.5 32.8-12.5 45.3 0l128 128c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L288 109.3zM64 352l128 0c0 35.3 28.7 64 64 64s64-28.7 64-64l128 0c35.3 0 64 28.7 64 64l0 32c0 35.3-28.7 64-64 64L64 512c-35.3 0-64-28.7-64-64l0-32c0-35.3 28.7-64 64-64zM432 456a24 24 0 1 0 0-48 24 24 0 1 0 0 48z"/></svg></label>
...
function vogo_render_question_list() {
    ...
    if ($query->have_posts()) {
        ...
        while ($query->have_posts()) {
            ...
            echo '<a href="https://vogo.family/question-thread/?question_id=' . get_the_ID() . '&city=' . urlencode($city_filter) . '&interest=' . urlencode($interest_filter) . '" style="display:flex; align-items:flex-start; gap:16px; text-decoration:none; color:inherit; width:100%;">';
            // Time at top right
