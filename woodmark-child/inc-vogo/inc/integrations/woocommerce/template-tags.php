...
if ( ! function_exists( 'woodmart_login_form' ) ) {
		...
		?>
			...
			>
				...
				<p class="woocommerce-FormRow woocommerce-FormRow--wide form-row form-row-wide form-row-username">
					...
					<input type="text" placeholder="Adresa de email *" class="woocommerce-Input woocommerce-Input--text input-text" name="username" id="username" value="<?php echo ( ! empty( $_POST['username'] ) ) ? esc_attr( $_POST['username'] ) : ''; ?>" /><?php //@codingStandardsIgnoreLine ?>
			...
			<div class="floating-group">
				...
				<!-- <input class="woocommerce-Input woocommerce-Input--text input-text" placeholder="Parolă *" type="password" name="password" id="password" autocomplete="current-password" /> -->
				<input type="password" class="input-text" placeholder="Parolă *" name="password" id="reg_password" required>
    ...
    <?php if ( get_option( 'users_can_register' ) ) : ?>
        <a href="<?php echo esc_url( wp_registration_url() ); ?>" class="woocommerce-Register register"><?php esc_html_e( 'Register', 'woodmart' ); ?></a>
    <?php endif; ?>
	...
	function woodmart_sidebar_login_form() {
		...
		?>
			<div class="login-form-side wd-side-hidden woocommerce<?php echo esc_attr( $wrapper_classes ); ?>">
				<div class="wd-heading">
					<span class="title"><?php esc_html_e( 'Conectare', 'woodmart' ); ?></span>
					<div class="close-side-widget wd-action-btn wd-style-text wd-cross-icon">
						<a href="#" rel="nofollow"><?php esc_html_e( 'Închide', 'woodmart' ); ?></a>
					</div>
				</div>
				<?php echo do_shortcode('[wc_login_form_custom]'); ?>
				<?php if ( ! is_checkout() ) : ?>
				...
				<div class="create-account-question">
					<p><?php esc_html_e( 'Nu ai încă un cont?', 'woodmart' ); ?></p>
					<a href="<?php echo esc_url( add_query_arg( 'action', 'register', $account_link ) ); ?>" class="btn create-account-button"><?php esc_html_e( 'Creează un cont', 'woodmart' ); ?></a>
				</div>
			</div>
		<?php
	}
