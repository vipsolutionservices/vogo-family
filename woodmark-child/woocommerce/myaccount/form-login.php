...
<?php endif; ?>
		...
		<h2 class="wd-login-title"><?php esc_html_e( 'Autentificare', 'woocommerce' ); ?></h2>
...
<?php if ( get_option( 'woocommerce_enable_myaccount_registration' ) === 'yes' ) : ?>
	...
	<div class="wd-col col-register">
		...
		<h2 class="wd-login-title"><?php esc_html_e( 'Înregistrare', 'woocommerce' ); ?></h2>
		...
		<form method="post" action="<?php echo esc_url( add_query_arg( 'action', 'register', $account_link ) ); ?>" class="woocommerce-form woocommerce-form-register register" <?php do_action( 'woocommerce_register_form_tag' ); ?> >
			...
			<?php if ( 'no' === get_option( 'woocommerce_registration_generate_username' ) ) : ?>
				...
				<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
					<label for="reg_username"><?php esc_html_e( 'Nume de utilizator', 'woocommerce' ); ?>&nbsp;<span class="required" aria-hidden="true">*</span><span class="screen-reader-text"><?php esc_html_e( 'Required', 'woocommerce' ); ?></span></label>
			...
			<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
				<label for="reg_email"><?php esc_html_e( 'Adresă de email', 'woocommerce' ); ?>&nbsp;<span class="required" aria-hidden="true">*</span><span class="screen-reader-text"><?php esc_html_e( 'Required', 'woocommerce' ); ?></span></label>
			...
			<?php if ( 'no' === get_option( 'woocommerce_registration_generate_password' ) ) : ?>
				...
				<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
					<label for="reg_password"><?php esc_html_e( 'Parolă', 'woocommerce' ); ?>&nbsp;<span class="required" aria-hidden="true">*</span><span class="screen-reader-text"><?php esc_html_e( 'Required', 'woocommerce' ); ?></span></label>
					<input type="password" class="woocommerce-Input woocommerce-Input--text input-text" name="password" id="reg_password" autocomplete="new-password" />
				</p>

			<?php else : ?>

				<p><?php esc_html_e( 'Un link pentru a seta o parolă nouă va fi trimis la adresa ta de email.', 'woocommerce' ); ?></p>
	...
	<?php if ( $tabs ) : ?>
		<div class="wd-col col-register-text">
			...
			<?php
				$reg_title   = woodmart_get_opt( 'reg_title' ) ? woodmart_get_opt( 'reg_title' ) : esc_html__( 'Înregistrare', 'woocommerce' );
				$login_title = woodmart_get_opt( 'login_title' ) ? woodmart_get_opt( 'login_title' ) : esc_html__( 'Autentificare', 'woocommerce' );
			...
			<?php
				$button_text = esc_html__( 'Înregistrare', 'woocommerce' );

			if ( isset( $_GET['action'] ) && 'register' === $_GET['action'] ) {
				$button_text = esc_html__( 'Autentificare', 'woocommerce' );
			}
			?>

			<a href="#" rel="nofollow noopener" class="btn wd-switch-to-register" data-login="<?php esc_html_e( 'Autentificare', 'woocommerce' ); ?>" data-login-title="<?php echo esc_attr( $login_title ); ?>" data-reg-title="<?php echo esc_attr( $reg_title ); ?>" data-register="<?php esc_html_e( 'Înregistrare', 'woocommerce' ); ?>"><?php echo esc_html( $button_text ); ?></a>
